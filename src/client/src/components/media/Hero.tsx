...
import { useTmdb } from "@/app/providers/tmdb-provider"
import { toast } from "sonner"
import type { Language, TrendingMovieResult } from "@lorenzopant/tmdb"
                        ...
                        .map(async (movie) => {
                            try {
                                const res = await tmdb.movies.images({
                                    movie_id: movie.id,
                                    language: "en-US",
                                    include_image_language: ["en-US"] as Language[],
                                })
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10 flex w-[93%] max-w-6xl items-center gap-12 px-10 text-white">
                                            <div className="max-w-xl space-y-4">
                                                ...
                                                <Button variant="outline" className="bg-white/70 backdrop-blur-sm" onClick={() => navigate(`/movie/${movie.id}`)}>
