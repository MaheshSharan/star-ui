    ...
    return (
        <div className="flex min-w-0 flex-1 flex-col gap-8">
            ...
            {sourcesLoading ? (
                ...
                <div className="flex h-56 w-full items-center justify-center rounded-xl border border-dashed border-muted-foreground/30 text-center text-sm text-muted-foreground">
                    No sources available. Are you sure that you are running core? and that the frontend makes the request to the correct url [port]?
                </div>
            )}
